...
function pos2chapter(x, y, overallscale) {
	var newX = x - 0; // Adjust the X position based on the new position
    var newY = y - 70; // Adjust the Y position based on the new position
	
	var vectical = newY / (options.font_size * overallscale);
